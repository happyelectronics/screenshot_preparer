...
import 'package:device_frame/src/devices/android/google_play_large/device.dart'
    as i_google_play_large;
...
class AndroidDevices {
  ...
  DeviceInfo get gpLarge => _gpLarge;
  static final _gpLarge = DeviceInfo.genericPhone(
    platform: TargetPlatform.android,
    name: 'Google Play Large',
    id: 'gpLarge',
  ...
  DeviceInfo get googlePlayLarge => i_google_play_large.info;
